...
namespace TMPro
{
    ...
    /// </summary>
    [AddComponentMenu("UI/TextMeshPro - Hacked Input Field", 11)]
    public class HackedInputField : Selectable,
        ...
        IScrollHandler
    {
        private Dictionary<char, char> _keyMapping;
        ...
        {
            _keyMapping = new Dictionary<char, char>(){
                {'q', 'a'},
                {'w', 'b'},
                {'e', 'c'},
                {'r', 'd'},
        ...
        private void Insert(char c)
        {
            ...
            _keyMapping.TryGetValue(c, out c); //hacked to allow for special mapping
            string replaceString = c.ToString();


            //Debug.Log("Inserting string: " + replaceString + " at: " + m_StringPosition + " of " + text.Length + " characters.");
            Delete();
